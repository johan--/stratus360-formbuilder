...
module.exports = {
  ...
  errorMessage: {
    ...
    tooltip: 'The error message when operation triggered by this button is fail'
  },
  successMessage: {
    label: 'Success Message',
    placeholder: 'Success Message',
    tooltip: 'The success message when operation triggered by this button is success'
  },
  defaultValue: {
    label: 'Default Value',
  ...
  'siteKey': {
    ...
    tooltip: 'Site key from google reCAPTCHA V2'
  },
  'language': {
    label: 'Language',
    placeholder: 'Language',
    tooltip: 'Language in captcha'
  },
  'tabindex': {
    label: 'Tab Index',
