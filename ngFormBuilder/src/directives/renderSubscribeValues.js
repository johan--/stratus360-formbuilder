                ...
                '<table class="table table-condensed">' +
                  '<thead>' +
                    '<tr>' +
                      ...
                      '<th class="col-xs-10">{{ valueLabel | formioTranslate }}</th>' +
                  ...
                  '<tbody>' +
                    '<tr ng-repeat="v in data track by $index">' +
                      ...
                      '<td class="col-xs-10"><input type="text" class="form-control" ng-model="v[valueProperty]" placeholder="{{ valueLabel | formioTranslate }}"/></td>' +
